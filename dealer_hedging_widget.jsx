...
export default function DealerHedgingWidget() {
  ...
  // Calculate dealer position based on price relative to strike
  const calculateDealerAction = () => {
    ...
    const normalizedDistance = Math.abs(distance) / 300; // Normalize to 0-1 range
    
    if (distance > 0) {
      // Above strike: dealers buy futures (creates resistance)
      return { 
      ...
      // Below strike: dealers sell futures (removes support)
      return { 
